...
The first example update_status.rb is pure quick and dirty coding, no framework, just a simple
ruby script that uses cucumber and will do the desired automation.
